...
createChat : ({ dateState : OptionalArgument GraphCool.Enum.DateState.DateState, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument GraphCool.InputObject.ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List GraphCool.InputObject.ChatmessagesMessage) } -> { dateState : OptionalArgument GraphCool.Enum.DateState.DateState, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument GraphCool.InputObject.ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List GraphCool.InputObject.ChatmessagesMessage) }) -> SelectionSet decodesTo GraphCool.Object.Chat -> Field (Maybe decodesTo) RootMutation
createChat fillInOptionals object =
    let
        ...
        optionalArgs =
            [ Argument.optional "dateState" filledInOptionals.dateState (Encode.enum GraphCool.Enum.DateState.toString), Argument.optional "canceledId" filledInOptionals.canceledId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "eventId" filledInOptionals.eventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "event" filledInOptionals.event GraphCool.InputObject.encodeChateventEvent, Argument.optional "initiatedId" filledInOptionals.initiatedId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "passedId" filledInOptionals.passedId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "proposedId" filledInOptionals.proposedId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "recipientId" filledInOptionals.recipientId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "messagesIds" filledInOptionals.messagesIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "messages" filledInOptionals.messages (GraphCool.InputObject.encodeChatmessagesMessage |> Encode.list) ]
                |> List.filterMap identity
    in
    Object.selectionField "createChat" optionalArgs object (identity >> Decode.maybe)


createEvent : ({ endsAt : OptionalArgument GraphCool.Scalar.DateTime, nameFull : OptionalArgument String, private : OptionalArgument Bool, createdById : OptionalArgument GraphCool.Scalar.Id, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List GraphCool.InputObject.EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.EventhostsHost), usersAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), usersLikedIds : OptionalArgument (List GraphCool.Scalar.Id), usersViewedIds : OptionalArgument (List GraphCool.Scalar.Id), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List GraphCool.InputObject.EventvenuesVenue) } -> { endsAt : OptionalArgument GraphCool.Scalar.DateTime, nameFull : OptionalArgument String, private : OptionalArgument Bool, createdById : OptionalArgument GraphCool.Scalar.Id, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List GraphCool.InputObject.EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.EventhostsHost), usersAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), usersLikedIds : OptionalArgument (List GraphCool.Scalar.Id), usersViewedIds : OptionalArgument (List GraphCool.Scalar.Id), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List GraphCool.InputObject.EventvenuesVenue) }) -> { name : String, startsAt : GraphCool.Scalar.DateTime } -> SelectionSet decodesTo GraphCool.Object.Event -> Field (Maybe decodesTo) RootMutation
createEvent fillInOptionals requiredArgs object =
    let
        ...
        optionalArgs =
            [ Argument.optional "endsAt" filledInOptionals.endsAt (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw), Argument.optional "nameFull" filledInOptionals.nameFull Encode.string, Argument.optional "private" filledInOptionals.private Encode.bool, Argument.optional "createdById" filledInOptionals.createdById (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.optional "chatsIds" filledInOptionals.chatsIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "chats" filledInOptionals.chats (GraphCool.InputObject.encodeEventchatsChat |> Encode.list), Argument.optional "hostsIds" filledInOptionals.hostsIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "hosts" filledInOptionals.hosts (GraphCool.InputObject.encodeEventhostsHost |> Encode.list), Argument.optional "usersAttendingIds" filledInOptionals.usersAttendingIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "usersLikedIds" filledInOptionals.usersLikedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "usersViewedIds" filledInOptionals.usersViewedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "venuesIds" filledInOptionals.venuesIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "venues" filledInOptionals.venues (GraphCool.InputObject.encodeEventvenuesVenue |> Encode.list) ]
                |> List.filterMap identity
    in
...
updateChat : ({ dateState : OptionalArgument GraphCool.Enum.DateState.DateState, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument GraphCool.InputObject.ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List GraphCool.InputObject.ChatmessagesMessage) } -> { dateState : OptionalArgument GraphCool.Enum.DateState.DateState, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument GraphCool.InputObject.ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List GraphCool.InputObject.ChatmessagesMessage) }) -> { id : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.Chat -> Field (Maybe decodesTo) RootMutation
...
updateEvent : ({ endsAt : OptionalArgument GraphCool.Scalar.DateTime, name : OptionalArgument String, nameFull : OptionalArgument String, private : OptionalArgument Bool, startsAt : OptionalArgument GraphCool.Scalar.DateTime, createdById : OptionalArgument GraphCool.Scalar.Id, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List GraphCool.InputObject.EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.EventhostsHost), usersAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), usersLikedIds : OptionalArgument (List GraphCool.Scalar.Id), usersViewedIds : OptionalArgument (List GraphCool.Scalar.Id), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List GraphCool.InputObject.EventvenuesVenue) } -> { endsAt : OptionalArgument GraphCool.Scalar.DateTime, name : OptionalArgument String, nameFull : OptionalArgument String, private : OptionalArgument Bool, startsAt : OptionalArgument GraphCool.Scalar.DateTime, createdById : OptionalArgument GraphCool.Scalar.Id, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List GraphCool.InputObject.EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.EventhostsHost), usersAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), usersLikedIds : OptionalArgument (List GraphCool.Scalar.Id), usersViewedIds : OptionalArgument (List GraphCool.Scalar.Id), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List GraphCool.InputObject.EventvenuesVenue) }) -> { id : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.Event -> Field (Maybe decodesTo) RootMutation
...
setVenueOnLocation : { locationLocationId : GraphCool.Scalar.Id, venueVenueId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.SetVenueOnLocationPayload -> Field (Maybe decodesTo) RootMutation
setVenueOnLocation requiredArgs object =
    Object.selectionField "setVenueOnLocation" [ Argument.required "locationLocationId" requiredArgs.locationLocationId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "venueVenueId" requiredArgs.venueVenueId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


unsetVenueOnLocation : { locationLocationId : GraphCool.Scalar.Id, venueVenueId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.UnsetVenueOnLocationPayload -> Field (Maybe decodesTo) RootMutation
unsetVenueOnLocation requiredArgs object =
    Object.selectionField "unsetVenueOnLocation" [ Argument.required "locationLocationId" requiredArgs.locationLocationId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "venueVenueId" requiredArgs.venueVenueId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


addToAttendingEvent : { eventsAttendingEventId : GraphCool.Scalar.Id, usersAttendingUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToAttendingEventPayload -> Field (Maybe decodesTo) RootMutation
addToAttendingEvent requiredArgs object =
    Object.selectionField "addToAttendingEvent" [ Argument.required "eventsAttendingEventId" requiredArgs.eventsAttendingEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersAttendingUserId" requiredArgs.usersAttendingUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
addToHostOfEvent : { eventsEventId : GraphCool.Scalar.Id, hostsHostId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToHostOfEventPayload -> Field (Maybe decodesTo) RootMutation
addToHostOfEvent requiredArgs object =
    Object.selectionField "addToHostOfEvent" [ Argument.required "eventsEventId" requiredArgs.eventsEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "hostsHostId" requiredArgs.hostsHostId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
addToLikedEvent : { eventsLikedEventId : GraphCool.Scalar.Id, usersLikedUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToLikedEventPayload -> Field (Maybe decodesTo) RootMutation
addToLikedEvent requiredArgs object =
    Object.selectionField "addToLikedEvent" [ Argument.required "eventsLikedEventId" requiredArgs.eventsLikedEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersLikedUserId" requiredArgs.usersLikedUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
addToMessageOfChat : { chatChatId : GraphCool.Scalar.Id, messagesMessageId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToMessageOfChatPayload -> Field (Maybe decodesTo) RootMutation
addToMessageOfChat requiredArgs object =
    Object.selectionField "addToMessageOfChat" [ Argument.required "chatChatId" requiredArgs.chatChatId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "messagesMessageId" requiredArgs.messagesMessageId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


addToRecipientOfChat : { recipientChatId : GraphCool.Scalar.Id, recipientUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToRecipientOfChatPayload -> Field (Maybe decodesTo) RootMutation
addToRecipientOfChat requiredArgs object =
    Object.selectionField "addToRecipientOfChat" [ Argument.required "recipientChatId" requiredArgs.recipientChatId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "recipientUserId" requiredArgs.recipientUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


addToUserIsHost : { hostsHostId : GraphCool.Scalar.Id, usersUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToUserIsHostPayload -> Field (Maybe decodesTo) RootMutation
addToUserIsHost requiredArgs object =
    Object.selectionField "addToUserIsHost" [ Argument.required "hostsHostId" requiredArgs.hostsHostId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersUserId" requiredArgs.usersUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


addToUserViewedEvent : { eventsViewedEventId : GraphCool.Scalar.Id, usersViewedUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToUserViewedEventPayload -> Field (Maybe decodesTo) RootMutation
addToUserViewedEvent requiredArgs object =
    Object.selectionField "addToUserViewedEvent" [ Argument.required "eventsViewedEventId" requiredArgs.eventsViewedEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersViewedUserId" requiredArgs.usersViewedUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


addToVenueOfEvent : { eventsEventId : GraphCool.Scalar.Id, venuesVenueId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.AddToVenueOfEventPayload -> Field (Maybe decodesTo) RootMutation
addToVenueOfEvent requiredArgs object =
    Object.selectionField "addToVenueOfEvent" [ Argument.required "eventsEventId" requiredArgs.eventsEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "venuesVenueId" requiredArgs.venuesVenueId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


removeFromAttendingEvent : { eventsAttendingEventId : GraphCool.Scalar.Id, usersAttendingUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromAttendingEventPayload -> Field (Maybe decodesTo) RootMutation
removeFromAttendingEvent requiredArgs object =
    Object.selectionField "removeFromAttendingEvent" [ Argument.required "eventsAttendingEventId" requiredArgs.eventsAttendingEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersAttendingUserId" requiredArgs.usersAttendingUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
removeFromHostOfEvent : { eventsEventId : GraphCool.Scalar.Id, hostsHostId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromHostOfEventPayload -> Field (Maybe decodesTo) RootMutation
removeFromHostOfEvent requiredArgs object =
    Object.selectionField "removeFromHostOfEvent" [ Argument.required "eventsEventId" requiredArgs.eventsEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "hostsHostId" requiredArgs.hostsHostId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
removeFromLikedEvent : { eventsLikedEventId : GraphCool.Scalar.Id, usersLikedUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromLikedEventPayload -> Field (Maybe decodesTo) RootMutation
removeFromLikedEvent requiredArgs object =
    Object.selectionField "removeFromLikedEvent" [ Argument.required "eventsLikedEventId" requiredArgs.eventsLikedEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersLikedUserId" requiredArgs.usersLikedUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
removeFromRecipientOfChat : { recipientChatId : GraphCool.Scalar.Id, recipientUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromRecipientOfChatPayload -> Field (Maybe decodesTo) RootMutation
removeFromRecipientOfChat requiredArgs object =
    Object.selectionField "removeFromRecipientOfChat" [ Argument.required "recipientChatId" requiredArgs.recipientChatId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "recipientUserId" requiredArgs.recipientUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


removeFromUserIsHost : { hostsHostId : GraphCool.Scalar.Id, usersUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromUserIsHostPayload -> Field (Maybe decodesTo) RootMutation
removeFromUserIsHost requiredArgs object =
    Object.selectionField "removeFromUserIsHost" [ Argument.required "hostsHostId" requiredArgs.hostsHostId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersUserId" requiredArgs.usersUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


removeFromUserViewedEvent : { eventsViewedEventId : GraphCool.Scalar.Id, usersViewedUserId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromUserViewedEventPayload -> Field (Maybe decodesTo) RootMutation
removeFromUserViewedEvent requiredArgs object =
    Object.selectionField "removeFromUserViewedEvent" [ Argument.required "eventsViewedEventId" requiredArgs.eventsViewedEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "usersViewedUserId" requiredArgs.usersViewedUserId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)


removeFromVenueOfEvent : { eventsEventId : GraphCool.Scalar.Id, venuesVenueId : GraphCool.Scalar.Id } -> SelectionSet decodesTo GraphCool.Object.RemoveFromVenueOfEventPayload -> Field (Maybe decodesTo) RootMutation
removeFromVenueOfEvent requiredArgs object =
    Object.selectionField "removeFromVenueOfEvent" [ Argument.required "eventsEventId" requiredArgs.eventsEventId (\(GraphCool.Scalar.Id raw) -> Encode.string raw), Argument.required "venuesVenueId" requiredArgs.venuesVenueId (\(GraphCool.Scalar.Id raw) -> Encode.string raw) ] object (identity >> Decode.maybe)
...
createUser : ({ bio : OptionalArgument String, nameFull : OptionalArgument String, createdEventsIds : OptionalArgument (List GraphCool.Scalar.Id), createdEvents : OptionalArgument (List GraphCool.InputObject.UsercreatedEventsEvent), datesCanceledIds : OptionalArgument (List GraphCool.Scalar.Id), datesCanceled : OptionalArgument (List GraphCool.InputObject.UserdatesCanceledChat), eventsAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), eventsAttending : OptionalArgument (List GraphCool.InputObject.UsereventsAttendingEvent), eventsLikedIds : OptionalArgument (List GraphCool.Scalar.Id), eventsLiked : OptionalArgument (List GraphCool.InputObject.UsereventsLikedEvent), eventsViewedIds : OptionalArgument (List GraphCool.Scalar.Id), eventsViewed : OptionalArgument (List GraphCool.InputObject.UsereventsViewedEvent), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.UserhostsHost), initiatedIds : OptionalArgument (List GraphCool.Scalar.Id), initiated : OptionalArgument (List GraphCool.InputObject.UserinitiatedChat), passedIds : OptionalArgument (List GraphCool.Scalar.Id), passed : OptionalArgument (List GraphCool.InputObject.UserpassedChat), proposedIds : OptionalArgument (List GraphCool.Scalar.Id), proposed : OptionalArgument (List GraphCool.InputObject.UserproposedChat), recipientIds : OptionalArgument (List GraphCool.Scalar.Id), recipient : OptionalArgument (List GraphCool.InputObject.UserrecipientChat), sentIds : OptionalArgument (List GraphCool.Scalar.Id), sent : OptionalArgument (List GraphCool.InputObject.UsersentMessage) } -> { bio : OptionalArgument String, nameFull : OptionalArgument String, createdEventsIds : OptionalArgument (List GraphCool.Scalar.Id), createdEvents : OptionalArgument (List GraphCool.InputObject.UsercreatedEventsEvent), datesCanceledIds : OptionalArgument (List GraphCool.Scalar.Id), datesCanceled : OptionalArgument (List GraphCool.InputObject.UserdatesCanceledChat), eventsAttendingIds : OptionalArgument (List GraphCool.Scalar.Id), eventsAttending : OptionalArgument (List GraphCool.InputObject.UsereventsAttendingEvent), eventsLikedIds : OptionalArgument (List GraphCool.Scalar.Id), eventsLiked : OptionalArgument (List GraphCool.InputObject.UsereventsLikedEvent), eventsViewedIds : OptionalArgument (List GraphCool.Scalar.Id), eventsViewed : OptionalArgument (List GraphCool.InputObject.UsereventsViewedEvent), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List GraphCool.InputObject.UserhostsHost), initiatedIds : OptionalArgument (List GraphCool.Scalar.Id), initiated : OptionalArgument (List GraphCool.InputObject.UserinitiatedChat), passedIds : OptionalArgument (List GraphCool.Scalar.Id), passed : OptionalArgument (List GraphCool.InputObject.UserpassedChat), proposedIds : OptionalArgument (List GraphCool.Scalar.Id), proposed : OptionalArgument (List GraphCool.InputObject.UserproposedChat), recipientIds : OptionalArgument (List GraphCool.Scalar.Id), recipient : OptionalArgument (List GraphCool.InputObject.UserrecipientChat), sentIds : OptionalArgument (List GraphCool.Scalar.Id), sent : OptionalArgument (List GraphCool.InputObject.UsersentMessage) }) -> { birthday : GraphCool.Scalar.DateTime, name : String, authProvider : GraphCool.InputObject.AuthProviderSignupData } -> SelectionSet decodesTo GraphCool.Object.User -> Field (Maybe decodesTo) RootMutation
createUser fillInOptionals requiredArgs object =
    let
        ...
        optionalArgs =
            [ Argument.optional "bio" filledInOptionals.bio Encode.string, Argument.optional "nameFull" filledInOptionals.nameFull Encode.string, Argument.optional "createdEventsIds" filledInOptionals.createdEventsIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "createdEvents" filledInOptionals.createdEvents (GraphCool.InputObject.encodeUsercreatedEventsEvent |> Encode.list), Argument.optional "datesCanceledIds" filledInOptionals.datesCanceledIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "datesCanceled" filledInOptionals.datesCanceled (GraphCool.InputObject.encodeUserdatesCanceledChat |> Encode.list), Argument.optional "eventsAttendingIds" filledInOptionals.eventsAttendingIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "eventsAttending" filledInOptionals.eventsAttending (GraphCool.InputObject.encodeUsereventsAttendingEvent |> Encode.list), Argument.optional "eventsLikedIds" filledInOptionals.eventsLikedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "eventsLiked" filledInOptionals.eventsLiked (GraphCool.InputObject.encodeUsereventsLikedEvent |> Encode.list), Argument.optional "eventsViewedIds" filledInOptionals.eventsViewedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "eventsViewed" filledInOptionals.eventsViewed (GraphCool.InputObject.encodeUsereventsViewedEvent |> Encode.list), Argument.optional "hostsIds" filledInOptionals.hostsIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "hosts" filledInOptionals.hosts (GraphCool.InputObject.encodeUserhostsHost |> Encode.list), Argument.optional "initiatedIds" filledInOptionals.initiatedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "initiated" filledInOptionals.initiated (GraphCool.InputObject.encodeUserinitiatedChat |> Encode.list), Argument.optional "passedIds" filledInOptionals.passedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "passed" filledInOptionals.passed (GraphCool.InputObject.encodeUserpassedChat |> Encode.list), Argument.optional "proposedIds" filledInOptionals.proposedIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "proposed" filledInOptionals.proposed (GraphCool.InputObject.encodeUserproposedChat |> Encode.list), Argument.optional "recipientIds" filledInOptionals.recipientIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "recipient" filledInOptionals.recipient (GraphCool.InputObject.encodeUserrecipientChat |> Encode.list), Argument.optional "sentIds" filledInOptionals.sentIds ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list), Argument.optional "sent" filledInOptionals.sent (GraphCool.InputObject.encodeUsersentMessage |> Encode.list) ]
                |> List.filterMap identity
    in
