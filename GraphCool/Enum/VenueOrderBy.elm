...
module GraphCool.Enum.VenueOrderBy exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid VenueOrderBy type, " ++ string ++ " try re-running the graphqelm CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : VenueOrderBy -> String
toString enum =
    case enum of
        CreatedAt_ASC ->
            "createdAt_ASC"
