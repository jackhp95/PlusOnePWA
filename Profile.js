...
var _user$project$Nav$tab = function (tuple) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href('Profile.html'),
			_1: {
				ctor: '::',
...
var _user$project$Nav$home = A2(
	_elm_lang$html$Html$a,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('white link'),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _user$project$Main$traitsIcons = function (traits) {
...
var _user$project$Main$profileToolsView = function () {
	var icon = function (x) {
		return A2(
			_elm_lang$html$Html$div,
			{
...
var _user$project$Main$pastEvents = function (model) {
	var eventCard = function (_p1) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('pr3 pl0 pt0 pb3'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('f4 fw6 pt2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('ma0 pv4 bb b--white-20'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('ph4 white'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Main$profileBio = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Main$profileAvi = function (avis) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('w5'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$profileView = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('w-100 bg-black-20 mw7-l overflow-auto'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('lg-breathe-50 flex h5 ph3 ph4-m ph5-l pt6 items-center'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Main$profileAvi(model.avi),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('f2 fw7 ml3'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('ph3 bg-black-20 w-100'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$Main$profileToolsView,
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Main$profileBio(model),
					_1: {
						ctor: '::',
						_0: _user$project$Main$traitsIcons(model.traits),
						_1: {
							ctor: '::',
							_0: _user$project$Main$pastEvents(model),
							_1: {
								ctor: '::',
								_0: _user$project$Main$traitsIcons(model.traits),
								_1: {ctor: '[]'}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('lg-breathe-50 overflow-hidden'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('white flex fw1 vh-100 bg-black-60'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('flex-auto pt5-m mb5 mb0-ns flex justify-stretch'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _user$project$Main$profileView(model),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {name: a, avi: b, traits: c};
	});
var _user$project$Main$Trait = F3(
	function (a, b, c) {
