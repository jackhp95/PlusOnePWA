...
type Page
    ...
    | Events Events.Model
    | Event EventID Event.Model
    | AddEvent AddEvent.Model

    | Venues Venues.Model
    | Venue VenueID Venue.Model

    | Performers Performers.Model
    | Performer PerformerID Performer.Model

    | Chats Chats.Model
    | Chat Username Chat.Model

    | Pool EventID Pool.Model
