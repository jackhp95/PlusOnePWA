...
var _user$project$Main$tachyonsCSS = 'tachyons.css';
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_user$project$Main_ops['=>'], 'background', 'url(\'https://randomuser.me/api/portraits/men/4.jpg\')'),
					_1: {
						ctor: '::',
...
var _user$project$Main$poolSize = F2(
...
var _user$project$Main$determineTubers = F2(
	function (model, windowSize) {
		var poolCols = A2(
			_elm_lang$core$List$range,
			0,
			(function (_) {
				...
				A2(_user$project$Main$poolSize, model, windowSize)) / _user$project$Main$spaceY(model.tube.spacing)) | 0);
		var poolRows = A2(
			_elm_lang$core$List$range,
			0,
			(function (_) {
				...
				A2(_user$project$Main$poolSize, model, windowSize)) / model.tube.spacing) | 0);
		return A2(
...
var _user$project$Main$updateHelp = F2(
	function (msg, _p4) {
		var _p5 = _p4;
		var _p22 = _p5.windowSize;
		var _p21 = _p5.users;
		var _p20 = _p5.tubers;
		var _p19 = _p5.tube;
		var _p18 = _p5.position;
		var _p17 = _p5.move;
		var _p16 = _p5;
		var _p6 = msg;
		switch (_p6.ctor) {
							...
							A2(
								...
								A2(
									...
									_elm_lang$core$Basics$round(
										_elm_lang$core$Tuple$first(
											_mpizenberg$elm_touch_events$Touch$clientPos(_p7))),
									_elm_lang$core$Basics$round(
							...
							function (_p8) {
								...
								return A2(
									...
									A2(
										...
										_elm_lang$core$Basics$round(
											_elm_lang$core$Tuple$first(
												_mpizenberg$elm_touch_events$Touch$clientPos(_p10))),
										_elm_lang$core$Basics$round(
											_elm_lang$core$Tuple$second(
												_mpizenberg$elm_touch_events$Touch$clientPos(_p10)))));
							},
			...
			case 'TouchEnd':
				return A6(
					...
					_user$project$Main$getPosition(_p16),
			...
			case 'MouseStart':
				...
				return _elm_lang$core$Native_Utils.update(
					...
					{
						move: _elm_lang$core$Maybe$Just(
							A2(_user$project$Main$Move, _p11, _p11))
					});
			case 'MouseMove':
				return _elm_lang$core$Native_Utils.update(
					_p16,
					{
						move: A2(
							...
							function (_p12) {
								var _p13 = _p12;
								return A2(_user$project$Main$Move, _p13.start, _p6._0);
							},
							_p17)
					});
			case 'MouseEnd':
			...
			case 'ResizePool':
				...
				return A6(
					...
					_p19,
					_p14,
					A2(_user$project$Main$determineTubers, _p16, _p14),
					_p21);
			default:
				var _p15 = _p6._0;
				return A6(
					...
					_p19,
					_p15,
					A2(_user$project$Main$determineTubers, _p16, _p15),
					_p21);
		}
	});
	...
	function (model, tuber) {
		var y = A2(
			...
			function (_) {
				...
				A2(_user$project$Main$poolSize, model, model.windowSize))) - ((model.tube.diameter / 2) | 0);
		var x = A2(
			F2(
				function (x, y) {
					return A2(_elm_lang$core$Basics_ops['%'], x, y);
...
var _user$project$Main$TouchCancel = function (a) {
	return {ctor: 'TouchCancel', _0: a};
};
var _user$project$Main$TouchEnd = function (a) {
	return {ctor: 'TouchEnd', _0: a};
};
var _user$project$Main$TouchMove = function (a) {
	return {ctor: 'TouchMove', _0: a};
};
var _user$project$Main$TouchStart = function (a) {
	return {ctor: 'TouchStart', _0: a};
};
var _user$project$Main$touchEvents = {
	ctor: '::',
	_0: _mpizenberg$elm_touch_events$SingleTouch$onStart(_user$project$Main$TouchStart),
	_1: {
		ctor: '::',
		_0: _mpizenberg$elm_touch_events$SingleTouch$onMove(_user$project$Main$TouchMove),
		_1: {
			ctor: '::',
			_0: _mpizenberg$elm_touch_events$SingleTouch$onEnd(_user$project$Main$TouchEnd),
			_1: {
				ctor: '::',
				_0: _mpizenberg$elm_touch_events$SingleTouch$onCancel(_user$project$Main$TouchCancel),
				_1: {ctor: '[]'}
			}
		}
	}
...
var _user$project$Main$MouseEnd = function (a) {
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_user$project$Main$MouseEnd),
					_1: {ctor: '[]'}
				}
			});
	}
...
var _user$project$Main$MouseStart = function (a) {
	return {ctor: 'MouseStart', _0: a};
};
var _user$project$Main$onMouseDown = A2(
	_elm_lang$html$Html_Events$on,
	'mousedown',
	A2(_elm_lang$core$Json_Decode$map, _user$project$Main$MouseStart, _elm_lang$mouse$Mouse$position));
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_1: {
											ctor: '::',
											_0: A2(_user$project$Main_ops['=>'], 'transform', 'scale(1.05)'),
											_1: {
												ctor: '::',
												_0: A2(
													_user$project$Main_ops['=>'],
