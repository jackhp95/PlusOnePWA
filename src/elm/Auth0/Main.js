...
var _user$project$Auth0_Auth0$UserProfile = F2(
	function (a, b) {
		return {email: a, email_verified: b};
	});
...
var _user$project$Auth0_Main$auth0authorize = _elm_lang$core$Native_Platform.outgoingPort(
	'auth0authorize',
	function (v) {
		return {};
	});
var _user$project$Auth0_Main$auth0authResult = _elm_lang$core$Native_Platform.incomingPort(
	'auth0authResult',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (err) {
...
var _user$project$Auth0_Main$auth0logout = _elm_lang$core$Native_Platform.outgoingPort(
	'auth0logout',
	function (v) {
		return null;
	});
var _user$project$Auth0_Main$Model = function (a) {
	return {authModel: a};
};
var _user$project$Auth0_Main$init = function (initialUser) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Auth0_Main$Model(
			A3(_user$project$Auth0_Authentication$init, _user$project$Auth0_Main$auth0authorize, _user$project$Auth0_Main$auth0logout, initialUser)),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Auth0_Main$AuthenticationMsg = function (a) {
	return {ctor: 'AuthenticationMsg', _0: a};
};
var _user$project$Auth0_Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{authModel: authModel}),
			_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Auth0_Main$AuthenticationMsg, cmd)
		};
	});
var _user$project$Auth0_Main$subscriptions = function (model) {
	return _user$project$Auth0_Main$auth0authResult(
		function (_p2) {
			return _user$project$Auth0_Main$AuthenticationMsg(
				_user$project$Auth0_Authentication$handleAuthResult(_p2));
		});
};
var _user$project$Auth0_Main$view = function (model) {
	return A2(
										...
										{ctor: '[]'},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													...
													'Hello, ',
													A2(_elm_lang$core$Basics_ops['++'], _p3._0.email, '!'))),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								};
									...
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											...
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Auth0_Main$AuthenticationMsg(
...
var _user$project$Auth0_Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Auth0_Main$init, update: _user$project$Auth0_Main$update, subscriptions: _user$project$Auth0_Main$subscriptions, view: _user$project$Auth0_Main$view})(
	_elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: _elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
...
var Elm = {};
Elm['Auth0'] = Elm['Auth0'] || {};
Elm['Auth0']['Main'] = Elm['Auth0']['Main'] || {};
if (typeof _user$project$Auth0_Main$main !== 'undefined') {
    _user$project$Auth0_Main$main(Elm['Auth0']['Main'], 'Auth0.Main', undefined);
}
