...
{-| Type alias for the `ChateventEvent` attributes. Note that this type
needs to use the `ChateventEvent` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/graphqelm/issues/33>.
-}
type alias ChateventEventRaw =
    { endsAt : OptionalArgument GraphCool.Scalar.DateTime, name : String, nameFull : OptionalArgument String, private : OptionalArgument Bool, startsAt : GraphCool.Scalar.DateTime, createdById : OptionalArgument GraphCool.Scalar.Id, poolId : OptionalArgument GraphCool.Scalar.Id, pool : OptionalArgument EventpoolPool, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List EventhostsHost), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List EventvenuesVenue) }


{-| Type for the ChateventEvent input object.
-}
type ChateventEvent
    = ChateventEvent ChateventEventRaw


{-| Encode a ChateventEvent into a value that can be used as an argument.
-}
encodeChateventEvent : ChateventEvent -> Value
encodeChateventEvent (ChateventEvent input) =
    Encode.maybeObject
        [ ( "endsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) |> Encode.optional input.endsAt ), ( "name", Encode.string input.name |> Just ), ( "nameFull", Encode.string |> Encode.optional input.nameFull ), ( "private", Encode.bool |> Encode.optional input.private ), ( "startsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) input.startsAt |> Just ), ( "createdById", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.createdById ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeEventpoolPool |> Encode.optional input.pool ), ( "chatsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.chatsIds ), ( "chats", (encodeEventchatsChat |> Encode.list) |> Encode.optional input.chats ), ( "hostsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.hostsIds ), ( "hosts", (encodeEventhostsHost |> Encode.list) |> Encode.optional input.hosts ), ( "venuesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.venuesIds ), ( "venues", (encodeEventvenuesVenue |> Encode.list) |> Encode.optional input.venues ) ]
...
encodeCreateChat (CreateChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
{-| Type alias for the `EventchatsChat` attributes. Note that this type
needs to use the `EventchatsChat` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/graphqelm/issues/33>.
-}
type alias EventchatsChatRaw =
...
{-| Type for the EventchatsChat input object.
-}
type EventchatsChat
    = EventchatsChat EventchatsChatRaw


{-| Encode a EventchatsChat into a value that can be used as an argument.
-}
encodeEventchatsChat : EventchatsChat -> Value
encodeEventchatsChat (EventchatsChat input) =
    Encode.maybeObject
...
{-| Type alias for the `PoolchatsChat` attributes. Note that this type
needs to use the `PoolchatsChat` type (not just a plain type alias) because it has
references to itself either directly (recursive) or indirectly (circular). See
<https://github.com/dillonkearns/graphqelm/issues/33>.
-}
type alias PoolchatsChatRaw =
...
-}
type PoolchatsChat
    = PoolchatsChat PoolchatsChatRaw


{-| Encode a PoolchatsChat into a value that can be used as an argument.
-}
encodePoolchatsChat : PoolchatsChat -> Value
encodePoolchatsChat (PoolchatsChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
type alias PooleventEventRaw =
    { endsAt : OptionalArgument GraphCool.Scalar.DateTime, name : String, nameFull : OptionalArgument String, private : OptionalArgument Bool, startsAt : GraphCool.Scalar.DateTime, createdById : OptionalArgument GraphCool.Scalar.Id, chatsIds : OptionalArgument (List GraphCool.Scalar.Id), chats : OptionalArgument (List EventchatsChat), hostsIds : OptionalArgument (List GraphCool.Scalar.Id), hosts : OptionalArgument (List EventhostsHost), venuesIds : OptionalArgument (List GraphCool.Scalar.Id), venues : OptionalArgument (List EventvenuesVenue) }
...
encodePooleventEvent (PooleventEvent input) =
    Encode.maybeObject
        [ ( "endsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) |> Encode.optional input.endsAt ), ( "name", Encode.string input.name |> Just ), ( "nameFull", Encode.string |> Encode.optional input.nameFull ), ( "private", Encode.bool |> Encode.optional input.private ), ( "startsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) input.startsAt |> Just ), ( "createdById", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.createdById ), ( "chatsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.chatsIds ), ( "chats", (encodeEventchatsChat |> Encode.list) |> Encode.optional input.chats ), ( "hostsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.hostsIds ), ( "hosts", (encodeEventhostsHost |> Encode.list) |> Encode.optional input.hosts ), ( "venuesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.venuesIds ), ( "venues", (encodeEventvenuesVenue |> Encode.list) |> Encode.optional input.venues ) ]
...
type alias UpdateChatRaw =
    { dateState : OptionalArgument GraphCool.Enum.DateState.DateState, id : GraphCool.Scalar.Id, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, poolId : OptionalArgument GraphCool.Scalar.Id, pool : OptionalArgument ChatpoolPool, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List ChatmessagesMessage) }
...
encodeUpdateChat (UpdateChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "id", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) input.id |> Just ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
encodeUpdateEvent (UpdateEvent input) =
    Encode.maybeObject
        [ ( "endsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) |> Encode.optional input.endsAt ), ( "id", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) input.id |> Just ), ( "name", Encode.string |> Encode.optional input.name ), ( "nameFull", Encode.string |> Encode.optional input.nameFull ), ( "private", Encode.bool |> Encode.optional input.private ), ( "startsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) |> Encode.optional input.startsAt ), ( "createdById", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.createdById ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeEventpoolPool |> Encode.optional input.pool ), ( "chatsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.chatsIds ), ( "chats", (encodeEventchatsChat |> Encode.list) |> Encode.optional input.chats ), ( "hostsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.hostsIds ), ( "hosts", (encodeEventhostsHost |> Encode.list) |> Encode.optional input.hosts ), ( "venuesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.venuesIds ), ( "venues", (encodeEventvenuesVenue |> Encode.list) |> Encode.optional input.venues ) ]
...
encodeUsercreatedEventsEvent (UsercreatedEventsEvent input) =
    Encode.maybeObject
        [ ( "endsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) |> Encode.optional input.endsAt ), ( "name", Encode.string input.name |> Just ), ( "nameFull", Encode.string |> Encode.optional input.nameFull ), ( "private", Encode.bool |> Encode.optional input.private ), ( "startsAt", (\(GraphCool.Scalar.DateTime raw) -> Encode.string raw) input.startsAt |> Just ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeEventpoolPool |> Encode.optional input.pool ), ( "chatsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.chatsIds ), ( "chats", (encodeEventchatsChat |> Encode.list) |> Encode.optional input.chats ), ( "hostsIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.hostsIds ), ( "hosts", (encodeEventhostsHost |> Encode.list) |> Encode.optional input.hosts ), ( "venuesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.venuesIds ), ( "venues", (encodeEventvenuesVenue |> Encode.list) |> Encode.optional input.venues ) ]
...
type alias UserdatesCanceledChatRaw =
    { dateState : OptionalArgument GraphCool.Enum.DateState.DateState, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument ChateventEvent, initiatedId : OptionalArgument GraphCool.Scalar.Id, passedId : OptionalArgument GraphCool.Scalar.Id, poolId : OptionalArgument GraphCool.Scalar.Id, pool : OptionalArgument ChatpoolPool, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List ChatmessagesMessage) }
...
encodeUserdatesCanceledChat (UserdatesCanceledChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
type alias UserinitiatedChatRaw =
    { dateState : OptionalArgument GraphCool.Enum.DateState.DateState, canceledId : OptionalArgument GraphCool.Scalar.Id, eventId : OptionalArgument GraphCool.Scalar.Id, event : OptionalArgument ChateventEvent, passedId : OptionalArgument GraphCool.Scalar.Id, poolId : OptionalArgument GraphCool.Scalar.Id, pool : OptionalArgument ChatpoolPool, proposedId : OptionalArgument GraphCool.Scalar.Id, recipientId : OptionalArgument GraphCool.Scalar.Id, messagesIds : OptionalArgument (List GraphCool.Scalar.Id), messages : OptionalArgument (List ChatmessagesMessage) }
...
encodeUserinitiatedChat (UserinitiatedChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
encodeUserpassedChat (UserpassedChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
encodeUserproposedChat (UserproposedChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "recipientId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.recipientId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
...
encodeUserrecipientChat (UserrecipientChat input) =
    Encode.maybeObject
        [ ( "dateState", Encode.enum GraphCool.Enum.DateState.toString |> Encode.optional input.dateState ), ( "canceledId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.canceledId ), ( "eventId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.eventId ), ( "event", encodeChateventEvent |> Encode.optional input.event ), ( "initiatedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.initiatedId ), ( "passedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.passedId ), ( "poolId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.poolId ), ( "pool", encodeChatpoolPool |> Encode.optional input.pool ), ( "proposedId", (\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.optional input.proposedId ), ( "messagesIds", ((\(GraphCool.Scalar.Id raw) -> Encode.string raw) |> Encode.list) |> Encode.optional input.messagesIds ), ( "messages", (encodeChatmessagesMessage |> Encode.list) |> Encode.optional input.messages ) ]
